...
segm <- fread("D:/analisi_in_corso/risk_1q_13/CoMMpass/GISTIC_1q13_segm_CoMMpass.txt") 
...
write.table(CALLS_AMP_MAJOR_sel,"D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/AMP_CALLS_major_focal_Compass.txt", sep = "\t", quote = F, row.names = T)
...
write.table(CALLS_DEL_MAJOR_sel,"D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/DEL_CALLS_major_focal_Compass.txt", sep = "\t", quote = F, row.names = T)
...
write.table(CALLS_AMP_CLONAL_sel, "D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/AMP_CALLS_clonal_focal.txt", sep = "\t", quote = F, row.names = T)
...
write.table(CALLS_DEL_CLONAL_sel,"D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/DEL_CALLS_clonal_focal.txt", sep = "\t", quote = F, row.names = T)
...
write.table(CALLS_AMP_ALL_sel, "D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/AMP_CALLS_all_focal.txt", sep = "\t", quote = F, row.names = T)
...
write.table(CALLS_DEL_ALL_sel,"D:/analisi_in_corso/risk_1q_13/CoMMpass/BROAD_FOCAL_CALLS/DEL_CALLS_all_focal.txt", sep = "\t", quote = F, row.names = T)
