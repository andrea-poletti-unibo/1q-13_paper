...
ggsave("C:/Users/mm_gr/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/PAPER_FIGURES_OFFICIAL/Venn4Ways/Venn_diagram_CoMM.pdf", 
       width = 7, height = 7)

venndf2 <- venndf_complete
venndf2$sum <- venndf2$`Amp 1q`+ venndf2$`Del 13q` + venndf2$HyperDiploidy + venndf2$`IgH Translocation`
