...
write_tsv(data.frame("Univariate"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
...
with(import, coxph(OS ~ PROTOCOL_REV  )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
...
#______ TX group mm risk 1 ______
...
#______ TX group mm risk 3 ______
...
#______ TX group mm risk 2 ______
...
#______ MANT group mm risk 1 ______
...
#______ MANT group mm risk 3 ______
...
#______ MANT group mm risk 2 ______
...
import$Induction_response_M_VGPR

# MV1 OS MMrisk1
mv1 <- coxph(OS ~ Induction_response_M_VGPR + OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV), data = import )
mv1 %>% summary()

mv1 <- coxph(OS ~ B2M + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14 + strata(PROTOCOL_REV), data=import)
mv1 %>% summary()


ggforest2(mv1, main = "OS - 1q&13+") 
ggsave(paste0(outpath,"FOREST_plot_mmrisk1_OS.png"))


#MV2 PFS MMrisk1
mv2 <-  with(import, coxph(PFS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV) )) 
mv2 %>% summary()
mv2 <- coxph(PFS ~ B2M + HB_m_105 + PLT_m_150 + MMrisk1 + ASCT + FISH_T_4_14 + FISH_Del_17p + strata(PROTOCOL_REV), data = import )
mv2 %>% summary()

ggforest2(mv2, main = "PFS 1q&13+") 
ggsave(paste0(outpath,"FOREST_plot_mmrisk1_PFS.png"))


#MV3 OS UltraHigh
mv3 <- with(import, coxph(OS ~ OLD_0_1 + HB_m_105 + PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) 
mv3 %>% summary()
mv3 <- coxph(OS ~ PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14  + FISH_Del_1p36 + strata(PROTOCOL_REV),data = import )
mv3 %>% summary()

ggforest2(mv3, main = "OS Ultra High Risk") 
ggsave(paste0(outpath,"FOREST_plot_UltraHigh_OS.png"))


#MV4 PFS UltraHigh
mv4 <- with(import, coxph(PFS ~ OLD_0_1 + HB_m_105 + PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV) )) 
mv4 %>% summary()
mv4 <- coxph(PFS ~ PLT_m_150 + ULTRA_High + ASCT  + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV), data = import )
mv4 %>% summary()

ggforest2(mv4, main = "PFS Ultra High Risk") 
...
#MV5 OS MMrisk3
mv5 <- coxph(OS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV), data = import )
mv5 %>% summary()

mv5 <- coxph(OS ~  B2M + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14 + strata(PROTOCOL_REV), data=import)
mv5 %>% summary()


ggforest2(mv5, main = "OS 1q&13-") 
ggsave(paste0(outpath,"FOREST_plot_mmrisk3_OS.png"))


#MV6 PFS MMrisk3
mv6 <- coxph(PFS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV), data = import )
mv6 %>% summary()

mv6 <- coxph(PFS ~ HB_m_105 + PLT_m_150 + MMrisk3 + ASCT  + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV), data=import)
mv6 %>% summary()


ggforest2(mv6, main = "PFS 1q&13-") 
...
#MV7 OS UltraLow
mv7 <- with(import, coxph(OS ~ OLD_0_1 + HB_m_105 + PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) 
mv7 %>% summary()
mv7 <- coxph(OS ~ PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_Del_1p36 + strata(PROTOCOL_REV) ,data = import )
mv7 %>% summary()

ggforest2(mv7, main = "OS Ultra Low Risk") 
ggsave(paste0(outpath,"FOREST_plot_UltraLow_OS.png"))



#MV8 PFS UltraLow
mv8 <- with(import, coxph(PFS ~ OLD_0_1 + HB_m_105 + PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV) )) 
mv8 %>% summary()
mv8 <- coxph(PFS ~ PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + HyperDiploidy + strata(PROTOCOL_REV) ,data = import )
mv8 %>% summary()

ggforest2(mv8, main = "PFS Ultra Low Risk" ) 
...
write_tsv(data.frame("MULTIVARIATA 1 - MMrisk1 - OS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ B2M + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14  + FISH_Del_1p36 + strata(PROTOCOL_REV) ))  %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)

write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 2 - MMrisk1 - PFS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk1 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ B2M + PLT_m_150 + MMrisk1 + ASCT  + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)


write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 3 - Ultra High - OS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14  + FISH_Del_1p36 + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)


write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 4 - Ultra High - PFS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + ULTRA_High + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ PLT_m_150 + ULTRA_High + ASCT  + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)


write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 5 - MMrisk3 - OS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ B2M + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14  + FISH_Del_1p36 + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)


write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 6 - MMrisk3 - PFS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ OLD_0_1 + B2M + ALBUMIN + HB_m_105 + PLT_m_150 + MMrisk3 + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(PFS ~ B2M + PLT_m_150 + MMrisk3 + ASCT  + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="PFS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)


write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
write_tsv(data.frame("MULTIVARIATA 7 - UltraLow - OS "),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ OLD_0_1 + HB_m_105 + PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + HyperDiploidy + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
write_tsv(data.frame("\n"),paste0(outpath,"report_cox_analysis_240321.txt"), append = T)
with(import, coxph(OS ~ PLT_m_150 + ULTRA_Low + ASCT + FISH_Del_17p + FISH_T_4_14 + FISH_T_14_16  + FISH_Del_1p36 + strata(PROTOCOL_REV) )) %>% tidy( exponentiate =T, conf.int = T) %>% cbind(surv="OS", .)%>% write_tsv(paste0(outpath,"report_cox_analysis_240321.txt"), append = T, col_names = T)
