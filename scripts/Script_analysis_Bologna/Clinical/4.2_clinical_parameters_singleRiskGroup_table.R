...
xlsx::write.xlsx(res_num_df, sheetName = "risk1_NUM_vars",
                 "C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx",
                 row.names = F)
