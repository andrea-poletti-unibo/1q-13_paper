...
tab_num_r1<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 1)
tab_cat_r1<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 2)

tab_num_r2<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 3)
tab_cat_r2<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 4)

tab_num_r3<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 5)
tab_cat_r3<- readxl::read_xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT 1q & 13 - Documenti/Supplementary/Tables/clinical_variables_in_MMrisk1_2_3_Bologna.xlsx", sheet = 6)
...
VARS <- c("HyperDiploidy", 
          ...
          "FISH_Del_17p",
          "FISH_Del_1p36",
          "AMP_maj-broad_chr_11p",
          "AMP_maj-broad_chr_11q",
          "DEL_maj-broad_chr_1p",
          "AMP_maj-broad_chr_18p",
          "AMP_maj-broad_chr_18q",
          "AMP_maj-focal_MYC",
          "DEL_maj-focal_TP53",
          "DEL_maj-focal_CDKN2C",
          "DEL_maj-focal_FAM46C",
          "DEL_maj-focal_CYLD",
          "DEL_maj-focal_TRAF3")
...
tab_cat_r1_VARS <- tab_cat_r1_VARS %>% mutate("code" = case_when(p.value>0.1 ~ "n.s.",
  ...
  mutate(variable=variable %>% str_replace("T_([0-9]+)_([0-9]+)","t\\(\\1;\\2\\)")) %>% 
...
all %>% kbl(caption = "1q&13 groups desctiption table - MM-BO dataset") %>%
  kable_classic(full_width = F, html_font = "Cambria") %>% save_kable("table_risk123_description.pdf",vwidth=500, vheight=300)
